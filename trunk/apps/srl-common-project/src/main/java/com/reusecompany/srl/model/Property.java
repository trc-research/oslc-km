...
public class Property extends GeneralData {
	
	// Properties for Metadata

	// TODO en C# esta clase hereda y ademas tiene la propiedad "DataTable" (la cual no sabria implementar)
	...
	public Property(String key, String value, SRLEnumTypes.SrlValueType valueType) {
		this.key = key;
		this.value = value;
		this.valueType = valueType;
	}

	public Property(String key, String value, SRLEnumTypes.SrlOperator operator, SRLEnumTypes.SrlValueType valueType) {
		this.key = key;
		this.value = value;
